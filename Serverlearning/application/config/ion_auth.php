...
|
*/
$config['collections']['users']          = 'dsi_users';
$config['collections']['groups']         = 'dsi_groups';
$config['collections']['login_attempts'] = 'dsi_attempts';
...
*/
$config['tables']['users']           = 'dsi_users';
$config['tables']['groups']          = 'dsi_groups';
$config['tables']['users_groups']    = 'dsi_users_groups';
$config['tables']['login_attempts']  = 'dsi_login_attempts';
 ...
 */
$config['site_title']           = "lukman.learning.com"; 		// Site Title, example.com
$config['admin_email']          = "lukman@learning.com"; 	// Admin Email, admin@example.com
$config['default_group']        = 'Maker'; 			// Default group, use name
